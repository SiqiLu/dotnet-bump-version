...
exports.default = exports.getJSDocComment = exports.getReducedASTNode = void 0;
...
const getTSFunctionComment = function getTSFunctionComment(astNode) {
  ...
  switch (node.type) {
    ...
    case 'FunctionExpression':
      if (!['CallExpression', 'OptionalCallExpression', 'NewExpression'].includes(parent.type)) {
        while (!sourceCode.getCommentsBefore(parent).length && !/Function/u.test(parent.type) && parent.type !== 'VariableDeclaration' && parent.type !== 'ExpressionStatement' && parent.type !== 'MethodDefinition' && parent.type !== 'Property') {
