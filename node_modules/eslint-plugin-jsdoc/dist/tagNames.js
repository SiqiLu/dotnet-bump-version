...
const jsdocTags = _objectSpread(_objectSpread({}, jsdocTagsUndocumented), {}, {
  abstract: ['virtual'],
  access: [],
  alias: [],
  async: [],
...
const typeScriptTags = _objectSpread(_objectSpread({}, jsdocTags), {}, {
...
const inheritdoc = typeScriptTags.inheritdoc,
      typeScriptTagsNoInheritdoc = _objectWithoutProperties(typeScriptTags, ["inheritdoc"]);

const closureTags = _objectSpread(_objectSpread(_objectSpread({}, typeScriptTagsNoInheritdoc), undocumentedClosureTags), {}, {
